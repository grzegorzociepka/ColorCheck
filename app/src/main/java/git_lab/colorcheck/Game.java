...
public class Game extends AppCompatActivity {
    ...
    String[] colText = {"@strings/red","@strings/green","@strings/blue","@strings/yellow","@strings/black","@strings/brown","burgundy","grey","olive","orange","pink","purple","salmon","white","akwamaryna","amethyst","chocolate","coral","lavender","navy","lemon"};
